...
| [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service) | Генерация и анализ отзывов (GPT-4o) | да | нет |
| [OpenRouter](https://openrouter.ai/) | Fallback LLM, если Azure недоступен | нет | есть бесплатные модели |
